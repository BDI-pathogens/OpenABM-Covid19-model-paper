...
input_parameter_file = relative_path("baseline_parameters.csv")
parameter_line_number = 1
output_dir = "."
household_demographics_file = relative_path("baseline_household_demographics.csv")
hospital_file = relative_path("hospital_baseline_parameters.csv")
